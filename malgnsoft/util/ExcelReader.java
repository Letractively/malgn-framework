...
public class ExcelReader {
	...
	public String getString(int x, int y) {
		...
		if(sheet != null) {
			try {
				...
				Malgn.errorLog("{ExcelReader.getString} " + e.getMessage());
			}
		}
		return ret;
	}
	...
	public int getInt(int x, int y) {
		...
		try {
			...
			Malgn.errorLog("{ExcelReader.getInt} " + e.getMessage());
		}
		return ret;
	}
	...
	public long getLong(int x, int y) {
		...
		try {
			...
			Malgn.errorLog("{ExcelReader.getLong} " + e.getMessage());
		}
		return ret;
	}
	...
	public double getDouble(int x, int y) {
		...
		try {
			...
			Malgn.errorLog("{ExcelReader.getDouble} " + e.getMessage());
		}
		return ret;
	}
