...
public class SqlMap {
	...
	public void reload() {
		try {
			...
			Malgn.errorLog("{SqlMap.reload} " + ex.getMessage());
		}
	}
	...
	public DataSet select(String id, HashMap pk) {
		...
		try {
			...
			setError(ex.getMessage());
			Malgn.errorLog("{SqlMap.select} " + ex.getMessage());
		}
		return rs;
	}
	...
	public boolean insert(String id, HashMap pk) {
		...
		try {
			...
			setError(ex.getMessage());
			Malgn.errorLog("{SqlMap.insert} " + ex.getMessage());
		}
		return ret;
	}
	...
	public boolean update(String id, HashMap pk) {
		...
		try {
			...
			setError(ex.getMessage());
			Malgn.errorLog("{SqlMap.update} " + ex.getMessage());
		}
		return ret;
	}
	...
	public boolean delete(String id, String pk) {
		...
		try {
			...
			setError(ex.getMessage());
			Malgn.errorLog("{SqlMap.delete} " + ex.getMessage());
		}
		return ret;
	}
